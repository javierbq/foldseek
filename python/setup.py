...
# Read version
def get_version():
    version_file = Path(__file__).parent / "pyfoldseek" / "_version.py"
...
# Access coordinates
print(struct.ca_coords)  # NumPy array (N, 3)
```

## Installation

```bash
pip install pyfoldseek
```

For more information, see the [Foldseek repository](https://github.com/steineggerlab/foldseek).
"""

setup(
    name="pyfoldseek",
    version=get_version(),
    author="Foldseek Team",
    author_email="",
    description="Python bindings for Foldseek structural search",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/steineggerlab/foldseek",
    project_urls={
        "Bug Tracker": "https://github.com/steineggerlab/foldseek/issues",
        "Documentation": "https://github.com/steineggerlab/foldseek/tree/master/python",
        "Source Code": "https://github.com/steineggerlab/foldseek",
    },
    packages=["pyfoldseek"],
    ext_modules=[CMakeExtension("pyfoldseek.pyfoldseek")],
